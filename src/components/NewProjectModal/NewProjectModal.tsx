...
export default function NewProjectModal({addNewProject}: newProjectModalProps) {
    ...
    return createPortal(
        <div className="modal-container fixed inset-0 w-screen h-screen bg-black/50 flex justify-center items-center">
            <form 
                ...
                <button className="m-4 p-2 pl-4 pr-4 bg-linear-60 from-orange-400 to-orange-200 rounded-xl border-2 border-orange-400 cursor-pointer">+ Add Task</button>
                <button type="submit" className="m-6 p-2 pl-4 pr-4 bg-linear-30 from-blue-950 to-blue-400 rounded-xl border-2 border-blue-800 text-white cursor-pointer hover:bg-amber-300">Add Project</button>
            </form>
        </div>
